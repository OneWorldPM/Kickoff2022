            ...
            <div class="row">
                <div class="col-md-12 m-t-50" style="text-align: -webkit-center;text-align: center;">
                    ...
                    <div class="col-md-12 m-b-60">
                        ...
                        <h1 style="color: white;font-size: 55px;font-weight: 600;">Event Extras</h1>
                    </div>
                </div>
            </div>
            <div class="row">
...
/*                                                    }
                                        ...
                                        <?php if($val->sessions_id == 15):?>
                                            <a class="button black-light button-3d rounded right" style="margin: 0px 0;background-color: #4087f6;border-color: #79acfb;" href="https://secure2.wish.org/site/TR/WishYourWay/Make-A-WishOrangeCountyandtheInlandEmpire?px=7001854&pg=personal&fr_id=4039#.YgkozGjMK3C" target="_blank"><span>Donate Now</span></a>
                                        <?php elseif ($val->sessions_id == 16): ?>
                                            <a class="button black-light button-3d rounded right" style="margin: 0px 0;background-color: #4087f6;border-color: #79acfb;" href="https://login.microsoftonline.com/39788527-8d04-48dd-b7b7-1b87b237519f/saml2?SAMLRequest=lVLJbtswEP0VgXdtVFTRhGVAtVHUQJIKsdtDb5Q4dghQpMKh7OTvq9Aukh6aolfOm3kblygGTUfeTP7RPMDTBOij50Eb5JdJTSZnuBWokBsxAHLf811zd8tpkvHRWW97q0nUIILzypq1NTgN4HbgTqqH7w%2B3NXn0fkSepuKotPIqwcssNvac9HZIjTiN4giJtCTazAqUEa%2Bn3ha1PSqTnJWR9oyJAZ8Wi4qxklYxk9lNfMOkjLuqq%2BK8Y1VHi6rMF4c0WCDRF%2Bt6CA5rchAagUTbTU129%2BtPLGd90TEhQFRycciKjgJblCX0lJWim4HYCkR1grdVxAm2Br0wviY0ozTOaJwX%2B7zkJeVFnuRF%2BZNE7TWbz7NqZY4fB9ldQMi%2F7vdt3H7b7cOBk5Lg7mf0%2F2X4AxyG%2FObTZLUMMfCg270v92NJ4nejZPUP7mX6nuHKN%2FJX3dtNa7XqX6JGa3teOxB%2B9uLdBKGWQfi%2Fi5iDDC9KxocA5TAIpRspHSCSdHXl%2FfP3rn4B&RelayState=https%3A%2F%2Fagiliti.service-now.com%2Fsp%3Fid%3Dsc_cat_item%26sys_id%3Deca38b5213a19e80bec35482e144b07f" target="_blank"><span>ServiceNow</span></a>
                                        <?php else: ?>
