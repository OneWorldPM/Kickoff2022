                                        ...
                                        <div class="post-item" style="background-color: white;padding-right: 25px;padding-left: 25px;">
                                            ...
                                            <div class="post-content-details col-md-9 m-t-30">
                                                ...
                                                <div class="post-title">
                                                    ...
                                                    <?php
                                                    if($val->sessions_id == 15)
                                                    { ?>
                                                        <h3><a href="<?= base_url() ?>sessions/morning_wellness" style="color: #f69240; font-weight: 900;"><?= $val->session_title ?></a></h3>
                                                        <?php
                                                    }elseif($val->sessions_id == 16){ ?>
<!--                                                        <h3><a href="<?//= base_url() ?>sessions/view/<?//= $val->sessions_id ?>" style="color: #f69240; font-weight: 900;"><?//= $val->session_title ?></a></h3>-->
                                                        <h3><span style="color: #f69240; font-weight: 900;"><?= $val->session_title ?></span></h3>
                                                        <?php
                                                    }elseif($val->sessions_id == 17){ ?>
                                                        <h3><span style="color: #f69240; font-weight: 900;"><?= $val->session_title ?></span></h3>
                                                    <?php
                                                    }
                                                    ?>
                                            ...
                                            if($val->sessions_id == 15)
                                            { ?>
                                                <a class="button black-light button-3d rounded right" style="margin: 0px 0;background-color: #4087f6;border-color: #79acfb;" href="<?= base_url() ?>sessions/morning_wellness"><span>View</span></a>
                                            <?php
                                            }elseif($val->sessions_id == 16){ ?>
<!--                                                <a class="button black-light button-3d rounded right" style="margin: 0px 0;background-color: #4087f6;border-color: #79acfb;" href="--><?//= base_url() ?><!--sessions/attend/<?//= $val->sessions_id ?>"><span>View</span></a>-->
                                                <a class="button black-light button-3d rounded right" style="margin: 0px 0;background-color: #4087f6;border-color: #79acfb;" href=https://www.youtube.com/watch?v=0Za3iAmFADI" target="_blank"><span>View</span></a>
                                            <?php
                                            }elseif($val->sessions_id == 17){ ?>
